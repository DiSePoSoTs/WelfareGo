...
<%@page import="it.wego.welfarego.tasklist.forms.TasklistPortletForm"%>
<%@page import="it.wego.persistence.PersistenceAdapter"%>
<% 
	TasklistPortletForm tasklistPortletForm=new TasklistPortletForm();
	tasklistPortletForm.doView(out);
%>
    </body>
</html>

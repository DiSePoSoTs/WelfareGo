...
<%@page import="it.wego.welfarego.determine.servlet.DeterminePortletForm"%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/determine.css">
        <!--        <link rel="stylesheet" type="text/css" href="ext/virtualkeyboard/css/virtualkeyboard.css"> -->
    </head>
    <body>
<% 
	DeterminePortletForm determinePortletForm=new DeterminePortletForm();
	determinePortletForm.doView(out);
%>
    </body>
</html>

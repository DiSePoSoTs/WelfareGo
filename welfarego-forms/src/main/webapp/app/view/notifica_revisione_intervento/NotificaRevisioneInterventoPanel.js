Ext.define('wf.view.notifica_revisione_intervento.NotificaRevisioneInterventoPanel',{
	extend: 'wf.view.GenericFormPanel',
	alias: 'widget.wf_notifica_revisione_intervento_panel',
	title: 'Notifica Revisione Intervento',
		...
		this.items = [{
			...
			items: [{
				...
				items: [{
					...
					id: 'wf_notifica_revisione_intervento_cognome_utente',
					name: 'cognome_utente'
				},{
					fieldLabel: 'Assistente sociale',
					id: 'wf_notifica_revisione_intervento_assist_soc',
					name: 'assist_soc'
				}]
			}]
		},{

Ext.define('wf.view.FilterField',{
	extend: 'Ext.form.field.Trigger',
	alias: 'widget.filter_field',
	//    constructor : function(config) {
	//        wtl.FilterField.superclass.constructor.call(this);
	//    },
	initComponent : function() {
		wf.view.FilterField.superclass.initComponent.call(this);
	...
	filter : function (text) {
		...
		store.proxy.extraParams[this.paramWhat] = text;
		var searchByField = null;
		if(this.searchByFieldId !=null){
			searchByField = Ext.getCmp(this.searchByFieldId);
		}
        
		if(this.searchByFieldId !=null && searchByField!=null){
			store.proxy.extraParams[this.paramBy]= searchByField.getValue();
		}
		this.getStore().load();
	},

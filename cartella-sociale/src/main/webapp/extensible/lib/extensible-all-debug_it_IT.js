...
Ext.define('Extensible.form.field.DateRange', {
     ...
     * The text to display as the label for the all day checkbox (defaults to 'Tutto il giorno')
     */
...
Ext.define('Extensible.calendar.form.EventDetails', {
    ...
    colWidthRight: .4,
    title: 'Eventi',
    titleTextAdd: 'Aggiungi Evento',
    titleTextEdit: 'Modifica Evento',
    titleLabelText: 'Titolo',
    datesLabelText: 'Periodo',
    reminderLabelText: 'Notifica',
    notesLabelText: 'Note',
    locationLabelText: 'Luogo',
    webLinkLabelText: 'Web Link',
    calendarLabelText: 'Calendario',
    repeatsLabelText: 'Ripetizione',
    saveButtonText: 'Salva',
    deleteButtonText: 'Cancella',
...
Ext.define('Extensible.calendar.view.AbstractCalendar', {
     ...
     * The text to display in the current day's box in the calendar when {@link #showTodayText} is true (defaults to 'Oggi')
     */
    todayText: 'Oggi',
    /**
...
Ext.define('Extensible.calendar.CalendarPanel', {
    ...
    /**
     * @cfg {String} todayText
     * Text to use for the 'Oggi' nav bar button.
     */
    todayText: 'Oggi',
    /**
     * @cfg {Boolean} showTodayText
     ...
     * Text to use for the 'Vai al' navigation label.
     */
    jumpToText: 'Vai al',
    /**
     * @cfg {String} goText
     * Text to use for the 'Vai' navigation button.
     */
    goText: 'Vai',
    /**
     * @cfg {String} dayText
     * Text to use for the 'Giorno' nav bar button.
     */
    dayText: 'Giorno',
    /**
    ...
    /**
     * @cfg {String} weekText
     * Text to use for the 'Settimana' nav bar button.
     */
    weekText: 'Settimana',
    /**
     * @cfg {String} multiWeekText
     * <p><b>Deprecated.</b> Please override {@link #getMultiWeekText} instead.</p>
     * <p>Text to use for the 'X Settimane' nav bar button (defaults to "{0} Weeks" where {0} is automatically replaced by the
     ...
     * Text to use for the 'Mese' nav bar button.
     */
    monthText: 'Mese',
    /**
     * @cfg {Boolean} editModal
    ...
    /**
     * Returns the text to use for the 'X Settimane' nav bar button (defaults to "{0} Weeks" where {0} is automatically replaced by the

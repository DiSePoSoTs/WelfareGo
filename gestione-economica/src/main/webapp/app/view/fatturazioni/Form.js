 ...
 * @date Luglio 2011
 *
 * Questa view definisce la form di ricerca per la sezione Fatturazioni
 */
...
(function(){
    ...
    function changePeriodoConsiderato(field, newValue) {
        var form = field.up('wpfatturazioniform'),
    ...
    Ext.define('Wp.view.fatturazioni.Form' ,{
        extend: 'Ext.form.Panel',
        alias : 'widget.wpfatturazioniform',
            ...
            beforerender:function(panel){
                if(!panel.wfgeAlreadyShownOnce){
                    ...
                    panel.getForm().setValues({
                        ...
                        stato_fatturazioni:Ext.getStore('StatiFatturazioni').first().getId()
                       // da_generare:true
                    });
        ...
        // prima riga
        {
            ...
            // classe
            {
                ...
                id: 'classe_intervento_fatturazioni',
                store: 'ClasseTipoInterventoFatturazioni',
                displayField: 'label',
                valueField: 'id',
                forceSelection: true,
                //                allowBlank: false,
            ...
            // tipo
            {
                ...
                id: 'tipo_intervento_fatturazioni',
                store: 'TipoInterventoFatturazioni',
                displayField: 'label',
                valueField: 'id',
                labelWidth: 25,
                forceSelection: true,
            ...
            items: [
                    {
                        xtype: 'combobox',
                        queryMode: 'local',
                        fieldLabel: 'Stato fatture',
                        name: 'stato_fatturazioni',
                        store: 'StatiFatturazioni',
                        displayField: 'label',
                        valueField: 'id',
                        forceSelection: true,
                        allowBlank:false,
        ...
        {
            text: 'Nuova fattura',
            action: 'nuovaFatturaVuota',
            tabIndex: 100
        },
        {
            text: 'Scarica file generato',
            tabIndex: 110,
            id:'scaricaFileGeneratoFatturaButton',
            disabled:true
        }
        ]// buttons
    });

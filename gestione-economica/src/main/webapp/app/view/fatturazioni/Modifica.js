 ...
 * creazione visualizzazione della modifica di una fattura.
 */

Ext.define('Wp.view.fatturazioni.Modifica', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wpfatturazionimodifica',
    items: [
        {
            xtype: 'gridpanel',
            ...
            items: [
                {
                    ...
                    columns: [
                        ...
                        {
                            text: 'Unisci con questa fattura?',

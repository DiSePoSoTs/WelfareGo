 ...
 *         &lt;element name="intervento" type="{http://cartellasociale.sanita.insiel.it}interventoType"/>
...
@XmlRootElement(name = "ModificaIntervento")
public class ModificaIntervento {

 ...
 */
@Embeddable
public class ComunePK implements Serializable {
	...
	public ComunePK(String codStato, String codProv, String codCom) {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof ComunePK)) {
			return false;
		}
		ComunePK other = (ComunePK) object;
	...
	public String toString() {
		return "it.wego.welfarego.persistence.entities.ComunePK[codStato=" + codStato + ", codProv=" + codProv
				+ ", codCom=" + codCom + "]";
	}
